...
( function( $ ) {
  ...
  wp.customize( 'blogify_menu_color', function( value ) {
      value.bind( function( to ) {
          $( '#main-nav' ).css( {
          	'background-color': to,
          	'border-color': to
  ...
  // Menu hover color
  wp.customize( 'blogify_menu_hover_color', function( value ) {
      value.bind( function( to ) {
  ...
  wp.customize( 'blogify_entry_color', function( value ) {
      value.bind( function( to ) {
          $( '.entry-content' ).css( {
          	'color': to
          } );
  ...
  wp.customize( 'blogify_element_color', function( value ) {
      value.bind( function( to ) {
  ...
  // Website title color
  wp.customize( 'blogify_logo_color', function( value ) {
      value.bind( function( to ) {
          $( '#site-title a' ).css( {
          	'color': to
          } );
  ...
  wp.customize( 'blogify_header_color', function( value ) {
      value.bind( function( to ) {
  ...
  // Wrapper color
  wp.customize( 'blogify_wrapper_color', function( value ) {
      value.bind( function( to ) {
          $( '.wrapper' ).css( {
          	'background-color': to
          } );
  ...
  wp.customize( 'blogify_content_bg_color', function( value ) {
      value.bind( function( to ) {
          $( '.widget, article' ).css( {
          	'background-color': to
          } );
  ...
  wp.customize( 'blogify_menu_item_color', function( value ) {
      value.bind( function( to ) {
  ...
  wp.customize( 'blogify_theme_options[header_show]', function( value ) {
      value.bind( function( to ) {
          ...
          var logo = wp.customize.instance( 'blogify_theme_options[header_logo]').get();
  ...
  // Header Logo Preview
  wp.customize( 'blogify_theme_options[header_logo]', function( value ) {
      value.bind( function( to ) {
          showOptions = (wp.customize.instance( 'blogify_theme_options[header_show]').get() != '') ? wp.customize.instance( 'blogify_theme_options[header_show]').get() : '';
          siteTitle = ( wp.customize.instance( 'blogname').get() != '') ? wp.customize.instance( 'blogname').get() : '';
          siteDesc = ( wp.customize.instance( 'blogdescription').get() != '') ? wp.customize.instance( 'blogdescription').get() : '';
          var divLogo = jQuery("#site-logo");
  ...
  wp.customize( 'blogify_theme_options[default_layout]', function( value ) {
      value.bind( function( to ) {
